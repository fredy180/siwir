    ...
    <body>
        <div id="Contenedor">
            ...
            <div class="layoutIzquierda">
                <a  href="PrincipalRegistro.jsp" > <h3  class="pestaña1"><center>Nuevo Proyecto</center></h3> </a>
                <a  href="PrincipalIngeniero.jsp" > <h3  class="pestaña1"><center>Gestionar Ingenieros</center></h3> </a>
            </div>
            ...
            <%
                ...
                cadena="";   
                while(rs.next()){
                  cadena=cadena +"<tr>"+"<td>"  + rs.getString(1)+"</td>"+"<td>"+rs.getString(2)+"</td>"+"</tr>";  
                }               
            %>
           <%=cadena%> 
