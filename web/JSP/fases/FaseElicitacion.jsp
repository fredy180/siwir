    ...
    <body>
        ...
        <div id="Contenedor">
            ...
            <div class="layoutIzquierda">
                ...
                <a  href="FaseEspecificacion.jsp" > <h3  class="pestaña1"><center>Especificacion</center></h3> </a>
            ...
            <div class="contenido">
                <%
                    ...
                    variablesGlobales.setFase("ELICITACION");
                    ResultSet rs = crud.consultarFase("ELICITACION", variablesGlobales.getProyecto());
                    if (rs.next()) {
