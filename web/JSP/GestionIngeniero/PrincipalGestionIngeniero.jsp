            ...
            <div class="contenido">
                ...
                <form name="formulario" method="post">
                    ...
                    <p>
                        ...
                        <input  <%="value='"+nombres+"'"%> class="der" type="text" name="nombres" id="direccion">
                    </p>
                    <br>
                    <p>
                        <label class="izq" for="apellido">Apallidos: </label>
                        <input  <%="value='"+apellidos+"'"%> class="der" type="text" name="apellidos" id="direccion">
                    </p>
                    <br>
                    <p>
                        <label class="izq" for="telefono">Telefono: </label>
                        <input  <%="value='"+telefono+"'"%> class="der" type="text" name="telefono" id="e_Mail">
                    </p>
                    <br>
                    <p>
                        <label class="izq" for="direcion">Direccion: </label>
                        <input  <%="value='"+direccion+"'"%> class="der" type="text" name="direccion" id="nombreProyecto">
                    </p>
                    <br>
                    <p>
