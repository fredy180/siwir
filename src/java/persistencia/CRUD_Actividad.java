...
public class CRUD_Actividad {
    public boolean insertarActividadFase(String proyecto,String tecnica,String fechaAplicacion,int cedulaResponsable) {
        boolean exito = false;
...
//            JOptionPane.showMessageDialog(null, "Nose Pueden Registrar Proyecto");
    ...
    public ResultSet consultarActividesFaseElicitacion(String proyecto) {
        ...
        ResultSet rs = null;
        try {
            String sql = "SELECT idRegistroElicitacion, tecnica,fechaAplicacion,"
    ...
    public ResultSet consultarActividFaseElicitacion(String proyecto, int idRegistroElicitacion) {
     ...
     public boolean actualizarActividadElicitacion(int idRegistroElicitacion, String proyecto,String tecnica, String fechaAplicacion, int cedulaResponsable) {
        boolean actualizado = false;
        String sql = "UPDATE registrosfaseelicitacion SET tecnica='" + tecnica + "',fechaAplicacion='"
                + fechaAplicacion + "',cedulaResponsable=" + cedulaResponsable
